...
class CenterNextButton extends StatelessWidget {
  ...
  /// Used to move onboarding to next page/step
  final VoidCallback onNextClick;

  /// Used to open Login screen
  ...
  Widget build(BuildContext context) {
    ...
    final bool isLastStep = _signUpMoveAnimation.value > 0.7;
                ...
                child: Container(
                  ...
                  child: PageTransitionSwitcher(
                    ...
                    child: isLastStep
                      ...
                      onTap: onLoginClick, // ✅ Sign Up -> Login screen
                      child: const Padding(
                      ...
                      onTap: onNextClick, // ✅ normal next step
                      child: const Padding(
            ...
            child: SlideTransition(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: onLoginClick, // ✅ Login text also opens login
                    child: const Text(
                      'Login',
                      style: TextStyle(
