...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void callAPI() {
    ...
    AppConstant.listDataOrders.clear();
    getOrderInfo();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: orderInfoVO != null &&
                ...
                AppConstant.listDataOrders.isNotEmpty
            ? RefreshIndicator(
                color: appColor(),
                onRefresh: _refresh,
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: AppConstant.listDataOrders.length + 1,
                        // Add 1 for load more
                        itemBuilder: (BuildContext context, int index) {
                          if (index == AppConstant.listDataOrders.length) {
      ...
      child: GestureDetector(
        onTap: () {
          AppConstant.ORDER_ID =
              AppConstant.listDataOrders[index].orderId.toString();
          AppConstant.ORDER_TRACKING_ID =
              AppConstant.listDataOrders[index].awb.toString();
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        // Set width to 10
                        decoration: BoxDecoration(
                          color: AppConstant.listDataOrders[index].isPortalOrder
                                      .toString() ==
                                  '1'
                              ? Colors.green
                              : Colors.red,
                          ...
                          child: Column(
                            ...
                            children: [
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            sizedBoxWWidget(10),
                                            AppConstant.listDataOrders[index]
                                                        .courierSlug !=
                                                    null
                                                ? Text(
                                                    AppConstant
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    AppConstant.listDataOrders[index].scanDate
                                        .toString(),
                                    style: TextStyle(
                                        fontSize: 11,
                                        fontFamily: fontName(),
  ...
  getOrderInfo() async {
    ...
    try {
      FormData formData = FormData.fromMap(<String, dynamic>{
        ...
        if (AppConstant.selectedScanUserIdOrderFilter
            .toString()
            .trim()
            .isNotEmpty)
          "scan_by_user_id":
          AppConstant.selectedScanUserIdOrderFilter.toString().trim(),
      });
        ...
        if (orderInfoVO != null && orderInfoVO!.success!) {
          if (orderInfoVO != null && orderInfoVO!.data!.orders!.length > 0) {
            if (orderInfoVO!.data!.pagination!.lastPage! >= page) {
              ...
              page++;
              AppConstant.listDataOrders.addAll(orderInfoVO!.data!.orders!);
              //print("leng --> " + AppConstant.listDataOrders.length.toString());
              setState(() {});
            }
          } else {
            isLoadMoreApiCall = false;
                              ...
                              Container(
                                ...
                                child: CustomDropdown(
                                  ...
                                  onSelected: (selectedItem) {
                                    ...
                                    AppConstant
                                            .selectedWarehouseNameOrderFilter =
